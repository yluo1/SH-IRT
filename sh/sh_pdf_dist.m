...
% C_pdf_ref = sh_nrm(sh_msq(sh_enc_rbf('SqExp', max_odr, theta, phi,  ell, is_real), is_real ), 'Sum');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Sample usage: Test real versus complex SH
...
%err_SW2 = norm(sh_pdf_dist(C_pdf_cpx, D_pdf_cpx, 'SlicedWasserstein2', false) - sh_pdf_dist(C_pdf_real, D_pdf_real, 'SlicedWasserstein2', true))
%err_KLD = norm(sh_pdf_dist(C_pdf_cpx, D_pdf_cpx, 'KLDiv', false) - sh_pdf_dist(C_pdf_real, D_pdf_real, 'KLDiv', true))
...
if strcmp(mode, 'SlicedWasserstein2')
    ...
    for n = 1:N
        ...
        C_pdf_rot = sh_rot(C_pdf, -[phi(n), theta(n), psi(n)], is_real, rot_intrinsic);
        D_pdf_rot = sh_rot(D_pdf, -[phi(n), theta(n), psi(n)], is_real, rot_intrinsic);
