...
$$y_n = \log T_{60}(\underline{\omega_n}, \underline{\theta_n}, \underline{\phi_n} ) - \log \overline{T}_{60}(\underline{\omega_n}), \quad 

\bf{x}_n = (\underline{\omega_n}, \underline{\theta_n}, \underline{\phi_n}).
$$
