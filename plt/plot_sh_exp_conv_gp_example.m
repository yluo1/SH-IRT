...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% E_mvnrnd_prior = sh_exp_conv_gp(C, [], is_real, 'Fs', Fs, 'options_mu', options_mu, 'options_cov', options_cov, ...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% E_mean_prior = sh_exp_conv_gp(C, [], is_real, 'Fs', Fs, 'options_mu', options_mu, 'options_cov', options_cov, ...
...
% E_mvnrnd_post = sh_exp_conv_gp(C, obs, is_real, 'Fs', Fs, 'options_mu', options_mu, 'options_cov', options_cov, ...
%       'max_odr_gp', max_odr_gp, 'sample_method_gp', 'mvnrnd', 'enable_disp', true);
...
[E_mean_post, h_fig_gp] = sh_exp_conv_gp(C, obs, is_real, 'Fs', Fs, 'options_mu', options_mu, 'options_cov', options_cov, ...
