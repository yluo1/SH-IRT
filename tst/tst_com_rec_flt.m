function tst_com_rec_flt
%Test commutative properties of convolution and recursive convolution
...
f_pre = ft_rec_conv_opt(conv(u, h), g);
f_pst = conv(u, ft_rec_conv_opt(h, g));
